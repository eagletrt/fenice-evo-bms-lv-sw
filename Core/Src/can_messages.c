...
void can_primary_ntw_handler(can_manager_message_t *msg) {
    switch (msg->id) {
        case PRIMARY_SET_RADIATOR_SPEED_FRAME_ID: {
            BMS_LV_MSG_HANDLER(primary, PRIMARY, set_radiator_speed, SET_RADIATOR_SPEED);
            break;
        }
        ...
        case PRIMARY_SET_INVERTER_CONNECTION_STATUS_FRAME_ID: {
            BMS_LV_MSG_HANDLER(primary, PRIMARY, set_inverter_connection_status, SET_INVERTER_CONNECTION_STATUS);
            break;
        }
