 ...
 * Generation date: 2024-07-13 14:58:38 +0200
...
static const uint16_t instances[] = {
    [ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE]      = 6,
    [ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE]       = 6,
    [ERROR_GROUP_BMS_LV_OPEN_WIRE]              = 1,
    [ERROR_GROUP_BMS_LV_ADC]                    = 1,
    [ERROR_GROUP_BMS_LV_CAN]                    = 2,
    [ERROR_GROUP_BMS_LV_SPI]                    = 1,
    [ERROR_GROUP_BMS_LV_OVER_CURRENT]           = 3,
    [ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE] = 12,
    [ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE]  = 12,
    [ERROR_GROUP_BMS_LV_MCP23017]               = 1,
    [ERROR_GROUP_BMS_LV_HEALTH]                 = 1};
/** @brief Error timeout for each group */
static const uint16_t timeouts[] = {
    [ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE]      = 400,
    [ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE]       = 400,
    [ERROR_GROUP_BMS_LV_OPEN_WIRE]              = 400,
    [ERROR_GROUP_BMS_LV_ADC]                    = 500,
    [ERROR_GROUP_BMS_LV_CAN]                    = 500,
    [ERROR_GROUP_BMS_LV_SPI]                    = 500,
    [ERROR_GROUP_BMS_LV_OVER_CURRENT]           = 400,
    [ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE] = 1000,
    [ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE]  = 200,
    [ERROR_GROUP_BMS_LV_MCP23017]               = 1000,
    [ERROR_GROUP_BMS_LV_HEALTH]                 = 700};

/** @brief List of errors where the data is stored */
static Error error_bms_lv_cell_undervoltage_instances[6];
static Error error_bms_lv_cell_overvoltage_instances[6];
static Error error_bms_lv_open_wire_instances[1];
static Error error_bms_lv_adc_instances[1];
static Error error_bms_lv_can_instances[2];
static Error error_bms_lv_spi_instances[1];
static Error error_bms_lv_over_current_instances[3];
static Error error_bms_lv_cell_under_temperature_instances[12];
static Error error_bms_lv_cell_over_temperature_instances[12];
static Error error_bms_lv_mcp23017_instances[1];
static Error error_bms_lv_health_instances[1];
static Error *errors[] = {
    [ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE]      = error_bms_lv_cell_undervoltage_instances,
    [ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE]       = error_bms_lv_cell_overvoltage_instances,
    [ERROR_GROUP_BMS_LV_OPEN_WIRE]              = error_bms_lv_open_wire_instances,
    [ERROR_GROUP_BMS_LV_ADC]                    = error_bms_lv_adc_instances,
    [ERROR_GROUP_BMS_LV_CAN]                    = error_bms_lv_can_instances,
    [ERROR_GROUP_BMS_LV_SPI]                    = error_bms_lv_spi_instances,
    [ERROR_GROUP_BMS_LV_OVER_CURRENT]           = error_bms_lv_over_current_instances,
    [ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE] = error_bms_lv_cell_under_temperature_instances,
    [ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE]  = error_bms_lv_cell_over_temperature_instances,
    [ERROR_GROUP_BMS_LV_MCP23017]               = error_bms_lv_mcp23017_instances,
    [ERROR_GROUP_BMS_LV_HEALTH]                 = error_bms_lv_health_instances};
...
void error_init(void (*cs_enter)(void), void (*cs_exit)(void)) {
    ...
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE]; ++i)
        error_bms_lv_cell_undervoltage_instances[i].group = ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE]; ++i)
        error_bms_lv_cell_overvoltage_instances[i].group = ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_OPEN_WIRE]; ++i)
        error_bms_lv_open_wire_instances[i].group = ERROR_GROUP_BMS_LV_OPEN_WIRE;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_ADC]; ++i)
        error_bms_lv_adc_instances[i].group = ERROR_GROUP_BMS_LV_ADC;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_CAN]; ++i)
        error_bms_lv_can_instances[i].group = ERROR_GROUP_BMS_LV_CAN;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_SPI]; ++i)
        error_bms_lv_spi_instances[i].group = ERROR_GROUP_BMS_LV_SPI;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_OVER_CURRENT]; ++i)
        error_bms_lv_over_current_instances[i].group = ERROR_GROUP_BMS_LV_OVER_CURRENT;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE]; ++i)
        error_bms_lv_cell_under_temperature_instances[i].group = ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE]; ++i)
        error_bms_lv_cell_over_temperature_instances[i].group = ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_MCP23017]; ++i)
        error_bms_lv_mcp23017_instances[i].group = ERROR_GROUP_BMS_LV_MCP23017;
    for (size_t i = 0; i < instances[ERROR_GROUP_BMS_LV_HEALTH]; ++i)
        error_bms_lv_health_instances[i].group = ERROR_GROUP_BMS_LV_HEALTH;
}
...
void error_expire_immediate(ErrorGroup group, ErrorInstance instance) {
    ...
    // Push data to the buffer
    ErrorData data = {.group = group, .instance = instance, .op = _error_expire_immediate};
    if (ring_buffer_push_back(&err_buf, &data) == RING_BUFFER_OK)
        error_routine();
}
