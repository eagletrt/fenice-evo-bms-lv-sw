...
void can_primary_ntw_handler(can_manager_message_t* msg) {
  switch (msg->id) {
    ...
    {
      BMS_LV_CAN_UNPACK_AND_HANDLER(primary, PRIMARY, set_radiator_speed, SET_RADIATOR_SPEED);
      break;
    }
    case PRIMARY_SET_PUMPS_SPEED_FRAME_ID:
    {
      BMS_LV_CAN_UNPACK_AND_HANDLER(primary, PRIMARY, set_pumps_speed, SET_PUMPS_SPEED);
      break;
    }
    case PRIMARY_SET_INVERTER_CONNECTION_STATUS_FRAME_ID:
    {
      BMS_LV_CAN_UNPACK_AND_HANDLER(primary, PRIMARY, set_inverter_connection_status, SET_INVERTER_CONNECTION_STATUS);
      break;
    }
    ...
    {  
      BMS_LV_CAN_UNPACK_AND_HANDLER(primary, PRIMARY, ts_status, TS_STATUS);
      break;
    }
    case INVERTERS_INV_L_RCV_FRAME_ID:
    {
      BMS_LV_CAN_UNPACK_AND_HANDLER(inverters, INVERTERS, inv_l_rcv, INV_L_RCV);
      break;
    }
    case INVERTERS_INV_R_RCV_FRAME_ID:
    {  
      BMS_LV_CAN_UNPACK_AND_HANDLER(inverters, INVERTERS, inv_r_rcv, INV_R_RCV);
      break;
    }
