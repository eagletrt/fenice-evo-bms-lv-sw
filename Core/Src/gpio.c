...
void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(
        GPIOC, PC13_NC_Pin | PC14_NC_Pin | RELAY_Pin | PC1_NC_Pin | MUX_A0_Pin | MUX_A1_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin PCPin */
    GPIO_InitStruct.Pin   = PC13_NC_Pin | PC14_NC_Pin | RELAY_Pin | PC1_NC_Pin | MUX_A0_Pin | MUX_A1_Pin;
