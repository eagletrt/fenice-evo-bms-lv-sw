...
#define LV_ERROR_SET_INT(error, instance) ERROR_UTILS_SET_INT(&error_handler, error, instance)
#define LV_ERROR_SET_STR(error, instance) ERROR_UTILS_SET_STR(&error_handler, error, instance)

#define LV_ERROR_RESET_INT(error, instance) ERROR_UTILS_RESET_INT(&error_handler, error, instance)
#define LV_ERROR_RESET_STR(error, instance) ERROR_UTILS_RESET_STR(&error_handler, error, instance)
