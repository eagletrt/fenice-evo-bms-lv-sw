 ...
 *
 * @details
 *     - ERROR_GROUP_BMS_LV_CELL_UNDERVOLTAGE no description
 *     - ERROR_GROUP_BMS_LV_CELL_OVERVOLTAGE no description
 *     - ERROR_GROUP_BMS_LV_OPEN_WIRE no description
 *     - ERROR_GROUP_BMS_LV_ADC no description
 *     - ERROR_GROUP_BMS_LV_CAN no description
 *     - ERROR_GROUP_BMS_LV_SPI no description
 *     - ERROR_GROUP_BMS_LV_OVER_CURRENT no description
 *     - ERROR_GROUP_BMS_LV_CELL_UNDER_TEMPERATURE no description
 *     - ERROR_GROUP_BMS_LV_CELL_OVER_TEMPERATURE no description
 *     - ERROR_GROUP_BMS_LV_MCP23017 no description
 *     - ERROR_GROUP_BMS_LV_HEALTH no description
 */
typedef enum {
